...
#ifndef  PSRELIABLITY_MODEL_H
#define PSRELIABLITY_MODEL_H
...
struct OutageTable
{
	...
	int start;
	// 确切频率
	std::vector<double> exactProbability;
	// 累积概率
	std::vector<double> accumulatedProbability;
	// 增量频率
	std::vector<double> incrementalFrequency;
	// 累计频率
	std::vector<double> accumulatedFrequency;

	OutageTable(int start)
		: start(start)
	{

	}
	OutageTable(OutageTable&& other)
		: start(other.start), exactProbability(std::move(other.exactProbability)), 
		accumulatedProbability(std::move(other.accumulatedProbability)),
		incrementalFrequency(std::move(other.incrementalFrequency)), 
		accumulatedFrequency(std::move(other.accumulatedFrequency))
	{
